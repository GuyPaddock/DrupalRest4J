...
extends DrupalConsumer
{
    ...
    throws IOException, DrupalHttpException
    {
        ...
        CloseableHttpClient httpClient          = HttpClientFactory.getInstance().getClient();

        try (CloseableHttpResponse  response            = this.executeRequest(request, httpClient, httpContext);
                                       ...
                                       SortOrder sortOrder)
    {
        ...
        {
            String criterionName = criterionEntry.getKey(), encodedValue;
            ...
            {
                throw new IllegalArgumentException("Bad criterion; '" + criterionName + "'='" + criterionValue + "': " +
                                                   ex.getMessage());
            }
